...
function front_end_form()
{
	...
	if(!isset($_COOKIE['maillistcookie'])){
		...
		if(get_option('mail_list_author_link')=="1"){echo '<a id="ml_author_link" href="http://daext.com" target="_blank" style="color: #'.get_option('mail_list_form_color').' !important;" title="Premium Plugins and Scripts" >daext</a>';}
